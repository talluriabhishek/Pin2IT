...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Create board</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT-->
			<!-- CREATE BOARD FORM -->
				<form class="createboard-form" action="boardvalidation.php" method="post">
					<div class="form-title">
						<h4 class="boardnameonbar">Create a board</h4>
					</div>
					<p class="hint">
						 Enter the board details below:
					</p>
					
					<div class="form-group col-md-4 ">
						<label class="control-label visible-ie8 visible-ie9">BoardName</label>
						<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="BoardName" name="boardname"/>
					</div>
					<br>
					<br>
					<br>
					<!-- sarechanges it to dropdown -->
					<div class="form-group col-md-4 ">
						<label class="control-label visible-ie8 visible-ie9">Sharetype</label>
						<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Sharetype" name="sharetype"/>
					</div>
					<br>
					<br>
					<br>
					...
					<div class="form-actions">
						...
						<button type="submit" id="register-submit-btn" class="btn btn-primary uppercase ">Create</button>
					</div>
				</form>
				<!-- END CREATE BOARD FORM -->
			<!-- END PAGE CONTENT-->
		</div>
	</div>
	<!-- END CONTENT -->
