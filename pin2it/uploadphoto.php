...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Upload photo</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT-->
			<!-- UPLOAD PHOTO FORM -->
				<form action="uploadphotovalidation.php" class="form-horizontal form-bordered" method="post" enctype = "multipart/form-data">
								<div class="form-body">
