...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Search Tags</title>
		...
		<div class="page-content">
			<form class="form-horizontal">
				<div class="form-group">
					<div class="col-md-5">
						<input class="form-control" type="text" id="searchKeyTag" name="searchKeyTag" placeholder="Enter your search key tag here">
					</div>
					<div class="col-md-2">
						<button id="srchButtonTag" class="btn btn-success" type="button">Search</button>
					</div>
				</div>
			</form>
			
			<div class="row mix-grid" style="      " id="searchresults">
