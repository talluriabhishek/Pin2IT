...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Pictures</title>
				...
				<div class="col-md-12">
					...
					?>
										<div class="col-md-3 col-sm-4 mix category_1"  >
											<div class="mix-inner "  >
											<?php
											echo '<img class="img-responsive" alt="" src="data:image/jpeg;base64,' . base64_encode($result['picture']) . '" />';
											?>
												<form action="pinpicture.php" method="post" >
													<div class="form-actions" >
													<?php
														echo '<button type="submit" class="btn btn-danger col-md-offset-4 col-md-4" value=" ' . $result['picId'] .'" name="picId">Pin</button>';
													?>
													</div>
												</form>
