...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Create Stream</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT-->
			<!-- CREATE BOARD FORM -->
				<form class="createboard-form" action="streamvalidation.php" method="post">
					<div class="form-title">
						<h2 class="boardnameonbar">Create a Stream</h2>
					</div>
					<p class="hint">
					...
					<div class="form-group col-md-4 ">
						<label class="control-label visible-ie8 visible-ie9">StreamName</label>
						<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="StreamName" name="streamname"/>
					</div>
					<br>
					<br>
					<br>
