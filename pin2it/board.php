...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Board</title>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<form action="followstream.php" class="form-horizontal form-row-sepe" method = "post" enctype = "multipart/form-data">
				...
				<?php
					echo '<input type="hidden" name="boardname" value = '.$boardname5.'>';
							...
							<div class="col-md-3 col-sm-4 mix category_1">
								<div class="mix-inner">
									...
									<?php 
										if(isset($_GET['otheruser'])){
											?>
											<a href = "repinpicture.php?otheruser=
											<?php 
												echo $_GET['otheruser']; 
												echo '&boardname='; 
												echo $_GET['boardname'];
												echo '&picId=';
												echo $picId ;
											?>" class="btn btn-danger col-md-3 repinbutton" id="repinbutton">Pin</a>
									<?php	}
									?>
