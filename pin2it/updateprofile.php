...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Update Profile</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT-->
			<!-- UPDATE PROFILE FORM -->
			<form class="register-form" action="updateprofilevalidation.php" method="post">
				<div class="form-title">
					<span class="boardnameonbar">Update Your Profile:</span>
				</div>
				
				<div>
				<div class="form-group ">
					<label class="control-label visible-ie8 visible-ie9">New FirstName</label>
					<input class="form-control placeholder-no-fix" type="text" placeholder="FirstName" name="newfirstname"/>
				</div>
				<!-- sarechanges  to place the present firstname and lastname-->
				<div class="form-group ">
					<label class="control-label visible-ie8 visible-ie9">New LastName</label>
					<input class="form-control placeholder-no-fix" type="text" placeholder="LastName" name="newlastname"/>
				</div>
				
				<div class="form-group ">
					<label class="control-label visible-ie8 visible-ie9">New Password</label>
					<input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="register_password" placeholder="Password" name="newpassword"/>
				</div>
				<div class="form-group">
					<label class="control-label visible-ie8 visible-ie9">Re-type Your Password</label>
					<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" name="newrpassword"/>
				</div>
				
				</div>
				<div class="form-actions">
					<a type="button" id="register-back-btn" href = "homepage.php" class="btn btn-default">Back</a>
					<button type="submit" id="register-submit-btn" class="btn btn-primary uppercase ">Update</button>
