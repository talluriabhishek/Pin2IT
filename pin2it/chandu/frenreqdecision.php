...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT-->
			<!-- REQUEST DECISION-->
				<form action="decisionvalidation.php" class="form-horizontal form-bordered" method="post" enctype = "multipart/form-data">
					<div class="form-actions">
						<div class="row">
							<div class="col-md-9 col-md-offset-4">
								<font size="4">You have a friend request from <a href="otherprofile.php?otheruser=<?php echo $_GET['friend'];?>"><?php echo $_GET['friend'];?></a><br><br></font>
								<input type="hidden" name="friend" value = "<?php echo $_GET['friend'];?>">
								<div class="col-sm-offset-1">
								<button type="submit" class="btn green" name="accept" value="1"><i class="fa fa-check"></i> Accept</button>
								<button type="submit" class="btn red" name="reject">Cancel</button>
								</div>
							</div>
						</div>
					</div>
