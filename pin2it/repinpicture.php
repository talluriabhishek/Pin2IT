...
$sql_prep_boards1->bind_result($boardname3);
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="col-md-3 col-sm-4 mix category_1"  >
				<form action="repinpicturevalidation.php" class="form-horizontal form-row-sepe" method = "post" enctype = "multipart/form-data">
					<div class="form-body">
						<?php
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select class="form-control input-medium select2me col-md-offset-4" placeholder="Select..." name = "boardname">
									<option value=""></option>
									<?php
										while($sql_prep_boards1->fetch()) 
										{									
											echo '<option value="'.$boardname3 . '"> '. $boardname3 .'</option>';							
										}
									?>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-5 col-md-9">
								<br>
								<input name="boardname2" value="<?php echo $boardname2; ?>" type="hidden"/>									
								<input name="otheruser" value="<?php echo $otheruser; ?>" type="hidden"/>									
								<input id="picId" value="<?php echo $picId; ?>" type="hidden"/>									
								<button type="submit" class="btn purple"><i class="fa fa-check"></i> Submit</button>
								<a class="btn default" href="board.php?otheruser=<?php echo $otheruser;echo '&boardname=';echo $boardname2;?>">Cancel</a>
							</div>
						</div>
					</div>
				</form>
