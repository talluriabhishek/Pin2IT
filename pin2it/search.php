...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Layouts - Search users</title>
		...
		<div class="page-content">
			<form class="form-horizontal">
				<div class="form-group">
					<div class="col-md-5">
						<input class="form-control" type="text" id="searchKey" name="searchKey" placeholder="Enter your search key here">
					</div>
					<div class="col-md-2">
						<button id="srchButton" class="btn btn-success" type="button">Search</button>
					</div>
				</div>
			</form>
			...
			<div id="searchresults">
				<div class="table-scrollable">
					<table id="searchresultsTable" class="table table-condensed table-hover">
						<thead>
						<tr>
							<th>
								 Username
...
<script src="assets/admin/layout/scripts/srchresults.js" type="text/javascript"></script>
<!-- END JAVASCRIPTS -->
</body>
<!-- END BODY -->
</html>